...
class DefaultConfigOptions(Jsonkin):
    ...
    * eval_save_suboptimal_models -- value to which reduce the objective function
    ...
    * train_generate_only -- Only generate training bn without running SD
    ...
    __def_options=dict(
        ...
        eval_save_suboptimal_models=2e-06, # value to which reduce the objective function
...
class SimulationConfig(Jsonkin):
    ...
    def __init__(self, **kwargs):
        ...
        # Evaluation Parameters
        self.eval_save_suboptimal_models = options['eval_save_suboptimal_models']
        ...
        # Generate Evaluation yRot -- 2pi/step
    ...
    def to_json(self) -> dict:
        ...
        return dict((k, jsonrepr(v)) for k, v in d.items())
